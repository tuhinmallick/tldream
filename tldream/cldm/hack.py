...
import tldream.ldm.modules.encoders.modules
import tldream.ldm.modules.attention

from transformers import logging
from tldream.ldm.modules.attention import default
...
def enable_sliced_attention():
    tldream.ldm.modules.attention.CrossAttention.forward = (
        _hacked_sliced_attentin_forward
    )
    logger.info("Enabled sliced_attention.")
    return


def hack_everything(clip_skip=0):
    disable_verbosity()
    tldream.ldm.modules.encoders.modules.FrozenCLIPEmbedder.forward = (
        _hacked_clip_forward
    )
    tldream.ldm.modules.encoders.modules.FrozenCLIPEmbedder.clip_skip = clip_skip
    logger.info("Enabled clip hacks.")
    return
